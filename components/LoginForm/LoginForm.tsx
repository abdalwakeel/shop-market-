  ...
  return (
    <Card className="w-full glass-card border border-border/30 shadow-xl rounded-2xl">
      ...
      <CardFooter className="flex flex-col gap-4">
        <Button disabled={isLoading} type="submit" onClick={form.handleSubmit(onSubmit)} className="w-full bg-red-600 text-white hover:opacity-90 rounded-xl transition-all shadow-lg shadow-[oklch(0.38_0.18_270)]/15">
