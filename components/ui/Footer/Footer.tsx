          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center text-gray-500 text-sm group">
                ...
                <span className="group-hover:text-gray-300 transition-colors">14 Shop Street, DOKI, DC 24680</span>
              </div>

              <div className="flex items-center text-gray-500 text-sm group">
                <Phone className="w-4 h-4 mr-2.5 text-gray-600 group-hover:text-[oklch(0.78_0.16_75)] transition-colors" />
                <span className="group-hover:text-gray-300 transition-colors">(+20)01119857458</span>
              </div>

              <div className="flex items-center text-gray-500 text-sm group">
                <Mail className="w-4 h-4 mr-2.5 text-gray-600 group-hover:text-[oklch(0.78_0.16_75)] transition-colors" />
                <span className="group-hover:text-gray-300 transition-colors">abdalwakeel85@gmail.com</span>
              </div>
            </div>
          </div>
